...
- Loops live at `components/loops/{category}/{name}.md` (markdown + frontmatter), install to `.claude/loops/`, and auto-install the components listed in their `components:` frontmatter field
