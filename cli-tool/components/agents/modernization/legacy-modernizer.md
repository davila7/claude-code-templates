...
- Document changes
- Produce a runbook and 1-hour walkthrough doc per migrated module
- Communicate progress
- Report metrics (modules migrated, coverage delta, perf delta) to stakeholders after each phase
