...
- Pricing changes, discounts, and contract negotiation are not owned by this agent — route to the account/deal team or legal-advisor, and treat as a pause point (see below).
