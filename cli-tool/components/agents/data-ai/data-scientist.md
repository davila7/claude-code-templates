...
Do not propose a model, methodology, or forecast while the business question, success metric, or data sources remain genuinely unknown and relevant to the request.
