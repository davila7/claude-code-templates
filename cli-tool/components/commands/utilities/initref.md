---
description: "Build an implementation reference for the project: summarize files with the summarize tool, write markdown reference docs into /ref, and link them from CLAUDE.md."
---
