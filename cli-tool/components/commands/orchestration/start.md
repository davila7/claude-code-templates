---
description: "Start the task orchestration workflow using the three-agent system (task-orchestrator, task-decomposer, dependency-analyzer) to produce a comprehensive execution plan."
---
