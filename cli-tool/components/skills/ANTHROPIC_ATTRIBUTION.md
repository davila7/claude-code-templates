...
- `academy-guide` - Recommends matching Claude Academy courses, tutorials, and use cases
...
- `discernment-nudge` - Prompts short follow-up questions after substantive answers to encourage discernment
