...
description: "When the user needs a professional marketer's operating mindset for a marketing, growth, or client-acquisition task — finding first customers, writing an ad or landing page, designing ad creatives, evaluating an idea, deciding whether doing X will produce Y, positioning or launching a B2B or SaaS product, running cold outreach, or writing copy. Also use when a user asks 'how do I get first clients,' 'should I do X to get Y,' 'how many sends before I can trust this channel,' or 'when should I kill this channel.' Not a tactical template library."
---
