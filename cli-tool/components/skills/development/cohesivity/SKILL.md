...
This skill does not manage its own installation or updates. Whatever delivered it owns that. The latest official version is served at `https://cohesivity.ai/skill.md`.
